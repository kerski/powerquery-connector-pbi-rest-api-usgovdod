# Power Query Custom Data Connector for Power BI REST APIs (US Government - Department of Defense)
...
4. Copy the [.mez file](https://github.com/kerski/powerquery-connector-pbi-rest-api-usgovdod/releases) to your folder "Documents\Power BI Desktop\Custom Connectors".  If the folder does not exist, create it first.
